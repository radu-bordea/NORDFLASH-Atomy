          ...
          <div className="absolute inset-0 flex flex-col justify-center px-4 md:px-10">
            <div className="max-w-[56%] md:max-w-[38%]">
              ...
              <div className="grid grid-cols-3 gap-x-6 gap-y-1">
                {[
                  {
                    img: "/assets/images/leaf.png",
                    title: "Ingrediente",
                    sub: "atent selecționate",
                  },
                  {
                    img: "/assets/images/formula.png",
                    title: "Formule",
                    sub: "testate",
                  },
                  {
                  ...
                  <div key={item.title} className="flex items-start gap-0.5">
                    ...
                    <div className="mt-1">
                      ...
                      <p
                        className="font-normal text-gray-500 leading-tight"
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      ...
                      <div key={f.name} className="relative">
                        <span
                          className="absolute top-1/2 -translate-y-1/2 text-violet-400"
                          style={{ left: "10px" }}
                        >
                          {f.icon}
                        </span>
          ...
          >
            ...
            <div className="text--center flex flex-col gap-0.5">
              ...
              <div className="flex items-center gap-2">
                <p className="text-gray-500 text-[11px] pl-10">
                  Răspund rapid!
                </p>
